...
ActiveRecord::Schema.define(version: 2019_01_31_120309) do
  ...
  create_table "doctors", force: :cascade do |t|
    ...
    t.index ["diplome_id"], name: "index_doctors_on_diplome_id"
  end
  ...
  create_table "specialties", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "diplome_id"
    t.index ["diplome_id"], name: "index_specialties_on_diplome_id"
  end
